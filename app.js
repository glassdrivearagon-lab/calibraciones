// app.js - Sistema de Calibraciones ADAS
...
class CalibrationSystem {
    ...
    async handleTechnicalSheet(e) {
        ...
        reader.onload = async (event) => {
            ...
            try {
                ...
                alert('Error al procesar la imagen. Por favor, intenta de nuevo o introduce los datos manualmente.');
                document.getElementById('ocrLoading').classList.add('hidden');
                document.getElementById('ocrResult').classList.remove('hidden');
            }
        };
    ...
    extractDataFromOCR(text) {
        ...
        if (!vinMatch && !matriculaMatch && !yearMatches) {
            alert('No se pudieron extraer datos automáticamente. Por favor, introduce los datos manualmente.');
        }
    }
